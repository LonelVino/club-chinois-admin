<template>
  <div class="congulations">
        ...
        <div class="animation02">
            ...
            <el-button @click="jump()" type="success" class="welcome-btn" style="position: absolute;
  top: 200px; margin-left:-6vw;
  transform: scale(1.5)">Start Prediction</el-button>
            <div class="name">
                <p>Welcome to EDF<br/>Wind turbine Power Prediction</p>
